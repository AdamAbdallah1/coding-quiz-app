const generalCodingQuestions = [
  {
    question: "What does IDE stand for?",
    options: ["Internet Development Environment", "Integrated Development Environment", "Integrated Debug Environment", "Internal Design Environment"],
